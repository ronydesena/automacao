...
export const IconBox = ({ color, className }: IIconBox) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="26"
      height="29.409"
      viewBox="0 0 26 29.409"
      fill={color}
      className={className}
    >
      <path
